...
📦 **[GitHub](https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker)** · 👤 **[Liên hệ](https://beacons.ai/huyvu2512)**

---

### 📊 Thống Kê Dự Án

[![Stars](https://img.shields.io/github/stars/huyvu2512/Celeb-Celeb-Tracker-Tracker?style=flat-square&label=⭐%20Stars&color=FFCC00)](https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker/stargazers)
[![Forks](https://img.shields.io/github/forks/huyvu2512/Celeb-Celeb-Tracker-Tracker?style=flat-square&label=🍴%20Forks&color=6e7681)](https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker/forks)
[![Issues](https://img.shields.io/github/issues/huyvu2512/Celeb-Celeb-Tracker-Tracker?style=flat-square&label=🐛%20Issues&color=f85149)](https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker/issues)
[![Last Commit](https://img.shields.io/github/last-commit/huyvu2512/Celeb-Celeb-Tracker-Tracker?style=flat-square&label=🕐%20Cập%20nhật&color=3fb950)](https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker/commits/main)
![Visitors](https://visitor-badge.laobi.icu/badge?page_id=huyvu2512.Celeb-Celeb-Tracker-Tracker&left_text=👁%20Lượt%20xem&left_color=6e7681&right_color=FF0000)
...
- **⚡ Phân tích link siêu tốc:** Phân giải (resolve) trực tiếp link `Celeb-Tracker.cam` để lấy thông tin chi tiết (avatar, tên, giới hạn slot) theo thời gian thực mà không cần tải ứng dụng.
...
📦 Celeb-Celeb-Tracker-Tracker
 ...
 ┃ ┣ 📜 Celeb-Tracker-resolver.js  # Trích xuất dữ liệu từ deep-link của Celeb-Tracker
...
1. Tải dự án về máy:
```bash
git clone https://github.com/huyvu2512/Celeb-Celeb-Tracker-Tracker.git
cd Celeb-Celeb-Tracker-Tracker
```
